...
function Registercmp() {
  ...
  return <div style={{backgroundImage:`url("../images/background.jpg")`,backgroundRepeat:"no-repeat",backgroundSize:"cover",marginTop:"-40px",paddingTop:"40px",height:"710px"}}>
